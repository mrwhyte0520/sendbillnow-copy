...
SELECT * FROM (VALUES
  ...
  (416220.01::NUMERIC, 624329.00::NUMERIC, 15::NUMERIC, 0::NUMERIC, '15% sobre excedente de $416,220.01', true, true),
  (624329.01::NUMERIC, 867123.00::NUMERIC, 20::NUMERIC, 31216.00::NUMERIC, '$31,216.00 + 20% sobre excedente de $624,329.01', true, true),
  (867123.01::NUMERIC, NULL::NUMERIC, 25::NUMERIC, 79776.00::NUMERIC, '$79,776.00 + 25% sobre excedente de $867,123.00', true, true)
...
COMMENT ON COLUMN public.payroll_tax_brackets.min_amount IS 'Monto mínimo del tramo en $';
COMMENT ON COLUMN public.payroll_tax_brackets.max_amount IS 'Monto máximo del tramo en $ (NULL = sin límite)';
