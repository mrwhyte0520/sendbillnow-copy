...
export const ROUTE_TO_MODULE: Record<string, string> = {
  ...
  '/accounts-receivable/invoices': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/customers': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/customer-types': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/payment-terms': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/payments': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/receipts': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/advances': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/discounts': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/credit-notes': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/debit-notes': MODULES.ACCOUNTS_RECEIVABLE,
  '/accounts-receivable/reports': MODULES.ACCOUNTS_RECEIVABLE,
